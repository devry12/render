 ...
 ?>
  ...
  <div class="row">
    ...
    <div class="form-group">
      ...
      <input type="text" name="namadepan"class="form-control" aria-describedby="nama">
    </div>
    <div class="form-group">
      <label for="">Nama Belakang</label>
      <input type="text" name="namabelakang"class="form-control" aria-describedby="nama">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="file" class="form-control-file" name = "file" aria-describedby="Avatar">
    </div>
    <br>
